  ...
  return (
    <div className='w-full h-full bg-[#3C1743] relative lg:min-h-screen'>
      ...
      <div className='flex justify-center absolute w-full h-full gap-10 top-0'>
        <div className='w-4/6 lg:w-5/6 mx-auto flex justify-center items-center flex-col '>
          <div className='hidden lg:block mb-[8%] lg:mb-[5%]'  data-aos="fade" data-aos-duration="1500" >
            <img src={process.env.PUBLIC_URL+'/images/header_title.png'} alt="" className='max-w-full w-4/5 mx-auto'/>
          </div>  
          <div className='lg:hidden mb-[8%] lg:mb-[5%]'  data-aos="fade" data-aos-duration="1500" data-aos-delay="500">
            <img src={process.env.PUBLIC_URL+'/images/header_title_mb.png'} alt="" className='max-w-full'/>
          </div>  
          <div className='w-auto lg:w-auto mx-auto mb-[8%] lg:mb-[5%] '  data-aos="fade" data-aos-duration="1500" data-aos-delay="500">
            <img src={process.env.PUBLIC_URL+'/images/header_logo.png'} alt="" className='max-w-full'/>
          </div> 
          <div className='w-auto lg:w-2/5  mx-auto '  data-aos="fade" data-aos-duration="1500" data-aos-delay="1000">
