  ...
  return (
    <div className='w-full h-full bg-[#3C1743] relative lg:min-h-screen'>
      ...
      <div className='flex justify-center absolute w-full h-full gap-10 top-0'>
        <div className='w-3/5 lg:w-5/6 max-auto flex justify-center items-center flex-col gap-10'>
          <div className='hidden lg:block'  data-aos="fade" data-aos-duration="1500" ><img src={process.env.PUBLIC_URL+'/images/header_title.png'} alt="" className='max-w-full'/></div>  
          ...
          <div className='w:3/4 lg:w-2/5  mx-auto '  data-aos="fade" data-aos-duration="1500" data-aos-delay="1000">
            <div className='hidden lg:block'><img src={process.env.PUBLIC_URL+'/images/header_subtitle1.png'} alt="" className='max-w-full mb-10'/></div>  
            <div className='lg:hidden'><img src={process.env.PUBLIC_URL+'/images/header_subtitle1_mb.png'} alt="" className='max-w-full mb-5'/></div>  
            <div className='hidden lg:block'><img src={process.env.PUBLIC_URL+'/images/header_subtitle2.png'} alt="" className='max-w-full'/></div> 
            <div className='w-3/4 mx-auto lg:hidden'><img src={process.env.PUBLIC_URL+'/images/header_subtitle2_mb.png'} alt="" className='max-w-full'/></div> 
          </div>
